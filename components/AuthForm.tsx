        ...
        <section className="auth-form">
            <header className="flex flex-col gap-5 md:gap-8">
                <Link href="/"
                    ...
                    <h1 className='font-ibm-plex-serif text-26 font-bold text-black-1'>BankBeam</h1>
                </Link>
                ...
                <div className="flex flex-col gap-1 md:gap-3">
                    ...
                    <p className="text-16 font-normal text-gray-600">
                        {user ?
                            "Link your bank account to get started" : 'Please enter your details'}
                    </p>
                </div>
            </header>
            {user ? ( 
                                ...
                                <>
                                    ...
                                    <div className="flex gap-4">
                                        <CustomInput 
                                            ...
                                            label="State" placeholder="Ex: Maharashtra"
                                        />
                                        <CustomInput 
                                            control={form.control} name="postalCode"
                                            label="Postal Code" placeholder="Ex: 401305"
                                        />
                                    </div>
                                    <div className="flex gap-4">
                                        <CustomInput 
